...
namespace App.Controllers
{
    ...
    public class CityController : ControllerBase
    {
        ...
        [ProducesResponseType(statusCode: StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Create([FromBody, Required] CityCreateDto country)
        {
            try
            {
        ...
        [ProducesResponseType(statusCode: StatusCodes.Status404NotFound)]
        [ProducesResponseType(statusCode: StatusCodes.Status200OK)]
        public async Task<IActionResult> Update([FromRoute, Required] int id, [FromBody, Required] CityEditDto city)
        {
            try
            {
                await _service.UpdateAsync(city, id);
                return Ok();
            }
            catch (NullReferenceException ex)
            {
